...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-06-2022 a las 18:06:17
...
--
CREATE DATABASE IF NOT EXISTS `ensayo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ensayo`;
...
('root', '[{\"db\":\"ensayo\",\"table\":\"actividades\"},{\"db\":\"ensayo\",\"table\":\"usuarios\"},{\"db\":\"ensayo\",\"table\":\"salud\"},{\"db\":\"ensayo\",\"table\":\"registros\"},{\"db\":\"ensayo\",\"table\":\"usuario\"}]');
...
('ensayo', 'actividades', 1, 152, 432),
('ensayo', 'salud', 1, 628, 432),
('ensayo', 'usuarios', 1, 392, 388);
...
('root', '2022-06-24 13:56:57', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\",\"Console\\/Height\":132.986}');
